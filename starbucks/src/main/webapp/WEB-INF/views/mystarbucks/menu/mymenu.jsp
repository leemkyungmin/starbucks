								...
								.on(
										...
										function() {
											...
											var checkboxLen = $(this)
													...
													.find('tbody')
													.find(
															'input:checkbox[name="drinkShop_view_ck2"]').length; // 개별 체크박스의 개수
											var checkboxCheckedLen = $(this)
													.parents('table')
													.find('tbody')
													.find(
															'input:checkbox[name="drinkShop_view_ck2"]:checked').length; // 개별 체크박스 중 선택된 체크박스의 개수
						...
						<fieldset>
									...
									<c:forEach var="mclist" items="${mclist}" varStatus="mcCount">
										...
										<td>
											<div class="ez-checkbox">
												<input type="checkbox" name="drinkShop_view_ck2" title="선택" value="${mclist.getMcIdx() }" class="ez-hide">
											</div>
										</td>
							...
							<div class="myMenu_btns">
								<ul>
									...
									<li><a href="javascript:void(0)" id="buy_myMenu">구매하기</a></li>
								</ul>
							</div>
						</fieldset>
					</article>
				...
				<div class="select_branch_wrap">
					<div class="search_wrap">
						...
						<div class="search_box_wrap">
							<input type="text" id="branch_info" placeholder="검색할 지역 또는 지점명"> <a href="javascript:void(0)" id="searchBtn">검색</a>
						</div>
									...
									<dl>
										...
										<dd>
											...
											<div class="card_pin_form">
												<input type="password" name="cardpinNum" id="cardpinNum" placeholder="카드 핀번호(8자리)" maxlength="8"> <a href="javascript:void(0)" id="buyproductBtn" data-uclidx="${ucllist.getUclIdx() }">결제하기</a>
											</div>
										</dd>
									</dl>
								</li>

							...
							<div class="product_main_img">
								<p>
									<a href="javascript:void(0);"> 
										<img class="zoomImg" alt="${ck.getCkName()}" src="${url}/resources/assets/images/coffee_img_test/large_${ck.getCkImg()}"
										data-zoom-image="${url}/resources/assets/images/coffee_img_test/large_${ck.getCkImg()}">
									</a>
								</p>
								<p class="more_btn">
									<a href="javascript:void(0);">

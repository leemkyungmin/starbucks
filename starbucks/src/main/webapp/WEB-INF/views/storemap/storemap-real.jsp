		...
		$().ready(function(){ 
			...
			var positions =[];
			 ...
			 if (navigator.geolocation) { // GPS를 지원하면
					        ...
					        for(var i = 0; i < result.length; i++) {
					            ...
					            if (result[i].region_type === 'H') {
					                ...
					                for(var i=0; i<$('.quickResultLstCon').length; i++){
		                				...
		                				var $addr =$('<div class="addr"/>').text($('.quickResultLstCon')[i].getAttribute('data-addr'));
		                				var $number =$(' <div class="number"/>').text('1522-3232');
		                				...
		                				if(positions.length == $('.quickResultLstCon').length) { 
				                			...
				                			for (var i = 0; i < positions.length; i ++) {	
				    					        ...
				    					        createoverlay(new kakao.maps.LatLng(overlays[i].lat,overlays[i].longti),overlays[i].content);
					...
					function createoverlay(postion,content){
